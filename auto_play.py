...
def play_song(track_uri):
    ...
    if preview_url:
        for _ in range(5):  # Retry twice if download fails
            ...
            print("Error downloading audio. Retrying...")
...
def main():
    ...
    if emotion_detection_button:
        ...
        selected_genre = select_random_genre(user_mood, lang.lower())
    ...
    if random_track_uri:
        ...
        if len(recently_played_songs) > len(track_uris):
        ...
        if audio_data is not None:
            ...
            st.warning("Song preview not available. Try again later.")
